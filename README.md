...
* miflora compatible - bluetooth scan for mac address
...
In case of multiple monitoring platforms, you may want to customize login_cookie_name in grafana.ini to avoid disconnections.
